...
response = openai.Completion.create(
    ...
    prompt=f"Check if the text is small talk or not,it is small talkor chit-chatif it is of 6 letters or less or an overwhelm or happiness or any combination of emotions but not a small talk if it is straight up a sentence asking something or just a statement. If it is small talk Return only 'it is chit-chat' as output else 'It is not a chit-chat' as output\n{text}",
    temperature=1,
    max_tokens=256,
    top_p=1,
    frequency_penalty=0,
